...
public class Gerenciador {
	...
	public void Gerar() {
		...
		//o metodo faz com que os numeros aletorios não se repitam dentro de seus conjuntos
		//após a geracao o metodo vai executar as perguntas de acordo com os numeros gerados
